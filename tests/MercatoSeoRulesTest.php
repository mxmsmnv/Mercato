...
if (!MercatoSeoRules::isPrivatePath('/checkout/') || !MercatoSeoRules::isPrivatePath('/order/receipt/opaque-code/') || !MercatoSeoRules::isPrivatePath('/order/status/opaque-code/') || !MercatoSeoRules::isPrivatePath('/products/mug/', ['token' => 'signed']) || MercatoSeoRules::isPrivatePath('/products/mug/')) throw new RuntimeException('Private-page exclusion rules failed.');
